...
data_files = {"train": ["data/train-00000-of-00004.parquet", "data/train-00001-of-00004.parquet", "data/train-00002-of-00004.parquet", "data/train-00003-of-00004.parquet"]}
dataset = load_dataset("parquet",
        data_dir=script_args.dataset_name,
...
ds = dataset.map(formatting_prompts_func, batched=True)
